...
<title>Settings | Join@TheTechieSia</title>
...
<div class="card mt-4 ms-3 me-3">
  <div class="card-body">
      ...
      <a href="../dashboard.php" class="btn btn-light"><?php echo htmlentities('<-'); ?> Channels List</a>&nbsp;&nbsp;<a onclick="logouttataplay()" class="btn btn-danger">Logout TataPlay - Join@TheTechieSia</a>
      <div class="mt-3">
