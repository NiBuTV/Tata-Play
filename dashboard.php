...
<head>
	...
	<title>Dashboard | Join-@TheTechieSia</title>
				...
				<div class="col-12">
					<div class="header__content">
						...
						<a href="dashboard.php" class="">
							<img src="img/tata-sky-logo.png" hieght="80" width="100" alt="Watch TataPlay Channels Live Here - @TheTechieSia" />
						</a>

						<ul class="header__nav">
						    <li class="header__nav-item">
								<a class="header__nav-link" href="app/index.php"> Settings - Join@TheTechieSia</a>
							</li>
						</ul>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright"> This Application Is Made Only For Personal Entertainment Purposes. Please Do Not Violate Any Kind of Laws. Join @TheTechieSia For More.</small>
					</div>
				</div>
			</div>
		</div>
